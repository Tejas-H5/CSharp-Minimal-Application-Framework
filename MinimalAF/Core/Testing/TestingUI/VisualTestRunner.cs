...
//        public override void AfterMount() {
...
//            ctx.SetDrawColor(Color.VA(1, .5f));
...
//        //    float sidePanelWidth = ctx.Width * 0.25f;
//        //    float inset = 5;
//        //    mountingContainer.RelativeRect = new Rect(sidePanelWidth, 0, ctx.Width * 1, ctx.Height * 1)
//        //        .Inset(inset);

//        //    testList.RelativeRect = new Rect(0, ctx.Height * 0.5f, sidePanelWidth, ctx.Height * 1 - 50)
//        //        .Inset(inset);

//        //    searchbox.RelativeRect = new Rect(0, ctx.Height * 1 - 50, sidePanelWidth, ctx.Height * 1)
//        //        .Inset(inset);

//        //    reflectionPanel.RelativeRect = new Rect(0, 0, sidePanelWidth, ctx.Height * 0.5f)
//        //        .Inset(inset);
