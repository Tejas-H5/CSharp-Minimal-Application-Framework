...
namespace MinimalAF {
    public partial class ProgramWindow {
        ...
        internal float MouseX => window.MouseState.Position.X;
        internal float MouseY => Height - window.MouseState.Position.Y;

        internal float MouseXDelta => window.MouseState.Delta.X;
        internal float MouseYDelta => -window.MouseState.Delta.Y;
